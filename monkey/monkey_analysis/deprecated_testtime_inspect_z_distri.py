...
plt.tight_layout()
plt.savefig("inpect1.png", dpi=300)
plt.close()
...
dists = {
    ...
    "Uniform [0, 0.01]": rng.uniform(0, 0.01, size=n_items),
    "Uniform [1e-4, 0.01]": rng.uniform(1e-4, 0.01, size=n_items),
    "Uniform [5e-3, 0.01]": rng.uniform(5e-3, 0.01, size=n_items),
    "Uniform [1e-3, 0.01]": rng.uniform(1e-3, 0.01, size=n_items),
}
...
plt.tight_layout()
plt.savefig("inpect2.png", dpi=300, bbox_inches="tight")