...
if __name__ == "__main__":
    device = "cpu"
    item_budget = 30 # why not 20
    sample_budget = 100
    max_workers = 16
    
    testtime_resmat2 = torch.load(f"irsl_testtime_resmat2_withz_betareg.pt", map_location="cpu", weights_only=False)
    ...
    for scen in tqdm(sorted(set(datasets))):
        output_dir = f"../../result/testtime_cat_resmat2/{scen}"
