...
if __name__ == "__main__":
    task2metric = lo("../gather_helm_data/task2metric.json")
    task2metric = pd.json_normalize(task2metric)

    all_paths = [
        "/lfs/skampere2/0/yuhengtu/auto_eval/src/benchmark_output/runs/gsm_DeepSeek-R1-Distill-Llama-8B-main/gsm:model=deepseek-ai_DeepSeek-R1-Distill-Llama-8B",
        "/lfs/skampere2/0/yuhengtu/auto_eval/src/benchmark_output/runs/gsm_DeepSeek-V2-Lite-Chat-main/gsm:model=deepseek-ai_DeepSeek-V2-Lite-Chat",
        "/lfs/skampere2/0/yuhengtu/auto_eval/src/benchmark_output/runs/gsm_Qwen3-8B-main/gsm:model=Qwen_Qwen3-8B",
        "/lfs/skampere2/0/yuhengtu/auto_eval/src/benchmark_output/runs/gsm_Qwen3-14B-main/gsm:model=Qwen_Qwen3-14B",
        "/lfs/skampere2/0/yuhengtu/auto_eval/src/benchmark_output/runs/gsm_Qwen3-32B-main/gsm:model=Qwen_Qwen3-32B",
    ]
    ...
    results.to_pickle(f"gsm_responses.pkl")
