...
# Plotting
rc = bundles.icml2024(usetex=True, family="serif")
rc.update({
    "font.size": 20,
    "axes.labelsize": 22,
    "axes.titlesize": 22,
...
with plt.rc_context(rc):
    ...
    ax.errorbar(M_arr, rmse_binary_mean, yerr=rmse_binary_std, fmt='o-', color=color_binary,
                linewidth=2, markersize=6, capsize=4, capthick=1.5, label='Binary-IRT 1PL')
    ax.errorbar(M_arr, rmse_beta_mean, yerr=rmse_beta_std, fmt='s-', color=color_beta,
                linewidth=2, markersize=6, capsize=4, capthick=1.5, label='Beta-IRT 1PL')
