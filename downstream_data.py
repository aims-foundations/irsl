...
if __name__ == "__main__":
    repo_ids = ["EleutherAI/pythia-6.9b", "EleutherAI/pythia-12b", "HuggingFaceTB/SmolLM2-1.7B-intermediate-checkpoints"]
    # LLM360/Amber
    ...
    for model_name in tqdm(model_names):
        ...
        results_dict[benchmark][scenario][model_name] = {
    ...
    with open(f"curve_results.pkl", "wb") as f:
